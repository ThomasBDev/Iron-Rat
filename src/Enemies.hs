...
data Enemy = Enemy { status :: Status, enemyY :: Float, enemyX :: Float, enemyType :: EnemyType, sprite :: Picture }
...
createEnemy (pos, enType, pic) = Enemy { status = Alive, enemyY = 0.0, enemyX = 0.0, enemyType = enType, sprite = newPic }
                               where
